// injected_ui.js
// V1,0: Slim "Cinematic" Aspect Ratio + Toggle + Smooth Blackout
...
(function() {
    ...
    Object.assign(container.style, {
        ...
        borderRadius: '6px', // Slightly sharper corners
        zIndex: '2147483647',
        pointerEvents: 'auto'
    });
    ...
    function gameLoop() {
        ...
        if (simValues.loadFactor !== undefined) {
            currentG = simValues.loadFactor;
        } else if (simValues.accZ !== undefined) {
            currentG = simValues.accZ / 9.81;
        }
        ...
        if (currentG > 5.0 || currentG < -2.0) {
            gText.style.color = '#ff3333'; 
            container.style.borderColor = 'rgba(255, 50, 50, 0.4)';
        } else {
            gText.style.color = '#33ffbb'; 
            container.style.borderColor = 'rgba(100, 200, 255, 0.2)';
        }
